...
4. `trd.md` — exact technical/contract/frontend requirements.
...
- Contract + frontend only: do not add a backend, database, API service, server action signer, Worker, D1, R2 or object store.
...
**Final label must be one of the dataset label schema at the case's rubric version.**
